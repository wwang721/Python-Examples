...
ax1.tick_params(axis='both', which="both", top=True, right=True) # show XY major and minor ticks on top and right
...
ax2.tick_params(axis='both', which="both", top=True, right=True) # show XY major and minor ticks on top and right
